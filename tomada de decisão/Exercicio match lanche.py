        ...
        case "3":
            ...
            match opc3:
                case "1":
                    ...
                    valor = quantidade31 * 25
                    print(f"Seu preço final e {valor}")

                case "2":
                    print("Sorvete - 18 reais")
                    quantidade3 = int(input("Digite a quantidade que deseja : "))
                    valor = quantidade3 * 18
                    print(f"Seu preço final e {valor}")
        case _:
            print("Opção invalida........")

    final +=valor
    opcao = input("Deseja continuar? digite S para continuar :").upper()
